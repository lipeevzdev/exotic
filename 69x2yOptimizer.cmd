...
echo.                                                                            ╔════════════════════════════════════════════════════╗
echo.                                                                            ║                                                    ║
echo.                                                                            ║     %w% Checking for Administrative Privelages...  ║
echo.                                                                            ║                                                    ║
echo.                                                                            ╚════════════════════════════════════════════════════╝
timeout /t 1 /nobreak > NUL
...
echo.                                                                            ╔════════════════════════════════════════════════════╗
echo.                                                                            ║                                                    ║
echo.                                                                            ║  %w% Running ScoreMatch as Administrator.║
echo.                                                                            ║                                                    ║
echo.                                                                            ╚════════════════════════════════════════════════════╝
timeout /t 1 /nobreak > NUL
chcp 437 >nul 2>&1
...
echo.                                                                                                                                                                 
echo.                                                  ╔═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
echo.                                                  ║            Permite que você reverta seu PC para as mesmas configurações que estava ao fazer o ponto de restauração      ║       
echo.                                                  ║             Você pode usar um ponto de restauração posteriormente no utilitário, se desejar fazê-lo                     ║     
echo.                                                  ╚═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
echo. 
...
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                                                                                                                            
echo.                                                            %p%[%w%1%p%]%w% Otimizações gerais              %p%[%w%2%p%]%w% Otimização de mouse e teclado       %p%[%w%3%p%]%w% Ajustes do Windows                                            
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%4%p%]%w% PC clean                           %p%[%w%5%p%]%w% Otimizações de memória                  %p%[%w%6%p%]%w% Desativar serviços de inicialização             
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%7%p%]%w% Otimizações de GPU                  %p%[%w%8%p%]%w% Otimizações de CPU                     %p%[%w%9%p%]%w% Otimizações USB                    
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%10%p%]%w% Otimização de energia                %p%[%w%11%p%]%w% Windows Debloat                       %p%[%w%12%p%]%w% Otimizações de armazenamento                
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%13%p%]%w% Corrigir arquivos corrompidos               %p%[%w%14%p%]%w% Definir otimização de tela cheia         %p%[%w%15%p%]%w% Desinstalar aplicativos inúteis              
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%16%p%]%w% Desativar animações inúteis        %p%[%w%17%p%]%w% Bloqueador de atualização do Windows               %p%[%w%18%p%]%w% Utilitário de ajuste de rede       
echo.                                                                                                                                                                                 
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%F%p%]%w% Correções                              %p%[%w%W%p%]%w% Otimize completamente o seu PC           %p%[%w%P%p%]%w% Usar ponto de restauração
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%R%p%]%w% Reverter                           %p%[%w%X%p%]%w% Sair do utilitário                      %p%[%w%E%p%]%w% ScoreMatch Discord
echo.                                                                                                                                                                                   
echo.                                                                                                                                                                                  
echo.                                                                  %w%  Feito por 69x2y , 2025 * Versão 1.0 *                   
echo.                                                                                                                                                                                 
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
echo.                                                                                                                      
echo.                                                                       %p%[%w%4%p%]%w% Reverter categoria de memória RAM / memória                                                
echo.                                                                                                                        
...
echo.  
echo.                                                                       %p%[%w%8%p%]%w% Reverter categoria de potência
echo.
echo.                                                                       %p%[%w%9%p%]%w% Reverter categoria de Debloat
echo.
echo.                                                                       %p%[%w%10%p%]%w% Reverter categoria de armazenamento
echo.
echo.                                                                       %p%[%w%11%p%]%w% Reverter Utilitário de Rede (opções 1-8)
echo.
echo.
echo.                                                                                                                       
...
echo.                                               %W% Ainda é recomendado usar um ponto de restauração se você quiser se livrar completamente dos ajustes
echo.                                             %b%"══════════════════════════════════════════════════════════════════════════════════════════════"
echo.
set /p input=:
...
echo.                                                           %b%"════════════════════════════════════════════════════════════════════════════════"%w%
echo.      
echo.                                                                            %p%[%w%1%p%]%w% Desinstalar aplicativos pré-instalados do Windows    
echo.  
echo.                                                                            %p%[%w%2%p%]%w% Desinstalar aplicativos inúteis por meio das configurações
echo.
echo.
...
echo.                                                                                                                                                                                              
echo.                                                                           %p%[%w%1%p%]%w% Desativar limitação de rede                    %p%[%w%2%p%]%w% Ativar processador de adaptador de rede integrado                      
echo.                                                                                                                                                                                               
echo.                                                                           %p%[%w%3%p%]%w% Definir índice de throttoling de rede               %p%[%w%4%p%]%w% Ativar o modo MSI no adaptador de rede                           
echo.                                                                                                                                                                                             
...
echo.                                                                                                                                                                                  
echo.                                                                           %p%[%w%9%p%]%w% Otimize o servidor Lanman                      %p%[%w%10%p%]%w% Otimizar as configurações do adaptador NIC                            
echo.                                                                                                                                                                                               
echo.                                                                           %p%[%w%11%p%]%w% Definir uma política de QOS                           %p%[%w%12%p%]%w% Abra as configurações da placa de rede                                         
echo.                                                                                                                                                                                              
echo.                                                        %b%"═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.                                                                                                                                                                                               
...
echo.                                              %b%"═══════════════════════════════════════════════════════════════════════════════════"%w%
echo.
echo.                                                 %p%[%w%1%p%]%w% Otimizar as configurações da placa de rede     %p%[%w%2%p%]%w% Reverter as configurações da placa de rede
echo.
echo.
echo.                                                                              %p%[%w%M%p%]%w% Voltar ao menu
echo. 
echo.                                              %b%"════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                  Otimiza a NIC (configurações da placa de interface de rede) para diminuir o ping e ajudar sua rede
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════════════"%w%
...
echo.
echo.                                                %b%"══════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                         Se a correção do número 4 não funcionar, você terá que pular esta etapa 
echo.
echo.                                                                                                                                                               
echo.                                                           %p%[%w%1%p%]%w% Iniciar PSCHED          %p%[%w%2%p%]%w% Ativar o MS-Pacer            %p%[%w%3%p%]%w% Abra o GPEDIT   
echo.  
echo.
echo.                                                           %p%%w%%p%%w%        %p%[%w%4%p%]%w% Baixe o GPEDIT (execute isso apenas se você não conseguir abrir o GPEDIT)  
echo. 
echo.                                                           %p%%w%%p%%w%                           %p%[%w%M%p%]%w% Back to menu   
echo.
echo.                                                %b%"══════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                              A política de %W%QoS define limites de limitação determina a taxa de tráfego de rede de saída
echo.                                                   %W% Basicamente, fará com que seu roteador priorize essa tarefa em detrimento de outras, diminuindo muito seu ping
echo.                                                %b%"══════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo. 
...
echo.  
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════"
echo.                                                 %W% Apare e desfragmente seu driver e aplique algumas otimizações extras de armazenamento 
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════"
echo. 
set /p input=:
...
echo.                                                                                                                      
echo.                                                             %p%[%w%1%p%]%w% Desativar notificações       %p%[%w%2%p%]%w% Otimizar a Pesquisa do Windows           
echo.                                                                                                                                
echo.                                                             %p%[%w%3%p%]%w% Desativar Bluetooth           %p%[%w%4%p%]%w% Desativar transparência    
echo.                                                                                                                                                                                                                 
echo.                                                             %p%[%w%5%p%]%w% Desativar relatório de erros     %p%[%w%6%p%]%w% Desativar sincronização de configuração            
echo.                                                                                                                                
echo.                                                             %p%[%w%7%p%]%w% Desativar diagnóstico         %p%[%w%8%p%]%w% Desativar aplicativos em segundo plano        
echo.
echo.                                                             %p%[%w%9%p%]%w% Desativar experimentos         %p%[%w%10%p%]%w% Alternar modo de jogo       
echo. 
echo.                                                             %p%[%w%11%p%]%w% Desativar manutenção         %p%[%w%12%p%]%w% Desativar rastreamento e alguns diagnósticos                            
echo. 
echo.                                                             %p%[%w%13%p%]%w% Desativar pop-ups + mais      %p%[%w%14%p%]%w% Desativar feed de atividades   
echo. 
echo.                                                             %p%[%w%15%p%]%w% Desativar tela inteligente       %p%[%w%16%p%]%w% Parar de reinstalar aplicativos pré-instalados 
echo.
echo.                                                             %p%[%w%17%p%]%w% Desativar experiências compartilhadas %p%[%w%18%p%]%w% Rastrear apenas eventos de falha importantes 
echo. 
echo.
echo.                                                             %p%%p%%p%%p%                     %p%[%w%M%p%]%w% voltar ao menu                                          
echo.     
...
echo.
echo.                                             %b%"══════════════════════════════════════════════════════════════════════════════════════════════"
echo.                                                               %W% Otimize várias configurações do Windows para um desempenho ideal 
echo.                                                         %W% Desativando um monte de coisas irritantes, como notificações, pop-ups e muito mais
echo.                                             %b%"══════════════════════════════════════════════════════════════════════════════════════════════"
echo.
set /p input=:
...
echo. 
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                          Recomendamos ativar o modo de jogo no Windows 11, mas desativá-lo no Windows 10                                               
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
echo.
echo.                                           %b%"══════════════════════════════════════════════════════════════════════════════════"
echo.                                                 %w% Localiza arquivos principais críticos necessários para executar e coletar informações 
...
echo.                                                                                                                      
echo.                                                               %p%[%w%5%p%]%w% Desabilitar a telemetria do Office  %p%[%w%6%p%]%w% Desativar impressão e mapas 
echo. 
echo.                                                               %p%[%w%7%p%]%w% Desinstalar a Cortana         %p%[%w%8%p%]%w% Desinstalar o Microsoft Edge     
echo.
echo.                                                               %p%[%w%9%p%]%w% Desativar registradores automáticos       %p%[%w%10%p%]%w% Desativar o Programa de Experiência do Cliente     
echo. 
echo.                                                               %p%[%w%11%p%]%w% Alternar mitigações       %p%[%w%12%p%]%w% Desativar biometria                             
echo.                                                                                                                               
...
echo.
echo.                                             %b%"══════════════════════════════════════════════════════════════════════════════════════════════"
echo.                                                                          %w% Não desative as coisas que você realmente usa!                         
echo. 
echo.                                                                    %w% Desinstala e desativa recursos inúteis no Windows
echo.                                                      %w% Remove o bloatware do sistema que é executado em segundo plano, ocupando recursos do sistema 
echo.                                             %b%"══════════════════════════════════════════════════════════════════════════════════════════════"
echo.
...
echo.                                              Nota: Você precisa ter as atualizações ativadas para que funcione, a reversão irá habilitá-las
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════"%w%
...
echo.                                              %b%"════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.
echo.                                                          %p%[%w%1%p%]%w% Desabilitar Mitigações %p%[%w%2%p%]%w% Habilitar Mitigações (reverter)
echo.
echo. 
echo.                                                                                        %p%[%w%M%p%]%w% Menu  
echo. 
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                  As mitigações são proteções contra ataques baseados em memória, mas têm um custo de desempenho
echo.                                                    Isso desativa vários básicos que causam perda de desempenho, mas não são tão importantes
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
echo.
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                     %W%Desinstala completamente o microsoft edge, há uma reversão para isso
echo.                                                         %W% Mas, infelizmente, a reversão não funciona 100% do tempo
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo. 
echo. 
...
echo.                                             %b%"═════════════════════════════════════════════════════════════════════════════════════"%w%              
echo.                                                                                                                                                                  
echo.                                                                %p%[%w%1%p%]%w% Trazer de volta os planos de energia padrão                                 
echo.                                                                                                                          
echo.                                                                %p%[%w%2%p%]%w% Reinstalar aplicativos padrão do Windows                                 
echo.                                                                                                                      
echo.                                                                %p%[%w%3%p%]%w% Ativar serviços XBOX                                    
echo.                                                                                                                      
echo.                                                                %p%[%w%4%p%]%w% Ativar DVR de Jogo                                                 
echo.                                                                                                                         
echo.                                                                %p%[%w%5%p%]%w% Ativar notificações                                           
echo.                                                                                                                       
echo.                                                                %p%[%w%6%p%]%w% Ativar Bluetooth      
echo.
echo.                                                                %p%[%w%7%p%]%w% Ativar serviços de impressão e mapas
echo.  
echo.                                                                %p%[%w%8%p%]%w% Reinstalar o Edge
echo.     
echo.                                                                %p%[%w%9%p%]%w% Ativar atualizações do Windows
echo.
echo.                                                                %p%[%w%10%p%]%w% Ativar o Windows Smart Screen
echo.
echo.                                                                %p%[%w%11%p%]%w% Ativar diagnóstico
echo.
echo.
echo.                                                                                                                       
echo.                                                                  %p%[%w%M%p%]%w% Voltar ao menu                                         
echo.                                                                              
echo.                                             %b%"═════════════════════════════════════════════════════════════════════════════════════"
echo.                                                  %W% Permite reverter várias configurações, sem precisar usar um ponto de restauração
echo.                                             %b%"═════════════════════════════════════════════════════════════════════════════════════"
echo.
set /p input=:
...
echo.                                                                             
echo.                                             %b%"════════════════════════════════════════════════════════════════════" %w%
echo.                                                                 %w% Selecione Que tipo de CPU você tem:   
echo.          
...
echo.                                                                     
echo.                                             %b%"══════════════════════════════════════════════════════════════════"
echo.                                                             %w% Selecione o tipo de GPU que você possui:  
echo. 
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                
echo.                                                        %p%[%w%1%p%]%w% Aplicar otimizações gerais de latência e desempenho 
echo. 
echo.                                                                                         
echo.                                                                            %p%[%w%M%p%]%w% Voltar ao menu   
echo.
...
echo.
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                        %W%Aplica otimizações gerais no registro, bcd-edit e muito mais!
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo. 
echo. 
...
echo.
echo.                                                                  %p%[%w%4%p%]%w% Excluir planos de energia inúteis 
echo.
echo.                                                                  %p%[%w%5%p%]%w% Desative a hibernação, inicialização rápida e muito mais     
echo. 
echo.                                                                  %p%[%w%6%p%]%w% Otimizar o intervalo de verificação do tempo de desempenho   
echo.
echo.      
...
echo.                                                         %W% Desativa um monte de recursos inúteis de economia de energia e muito mais
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════"
echo.
echo.
...
echo.                                              %b%"════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.
echo.                                                       %p%[%w%1%p%]%w% Planos de energia padrão %p%[%w%2%p%]%w% Pular e ir para o menu
echo.
echo.                                                                                     
echo.                                                                                %p%[%w%R%p%]%w% Planos de energia padrão 
echo.
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                           Exclui planos de energia padrão (Balanceado, Economia de energia e Alto desempenho)                                              
echo.                                              %b%"═════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
echo.          
echo.                                             %b%"═════════════════════════════════════════════════════════════════════════════"%w%                                           
echo.                                                                         Selecione a quantidade de memória RAM que você tem:              
echo.                                                                                          
...
echo.                                                                                   
echo.                                             %b%"══════════════════════════════════════════════════════════════════════════════"%w% 
echo.                                                 %w% Otimiza vários valores de registro relacionados à RAM para um desempenho ideal 
echo.                                                   %W% Desativa um monte de recursos inúteis que prejudicam seu desempenho
echo.                                             %b%"══════════════════════════════════════════════════════════════════════════════"%w% 
echo.
echo.
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                
echo.                                                                   %p%[%w%1%p%]%w% Aceleração de hardware da GPU desativada (recomendada)
echo.  
echo.                                                                   %p%[%w%2%p%]%w% Aceleração de hardware da GPU ativada (padrão)
echo. 
echo.                                                                                         
echo.                                                                             %p%[%w%M%p%]%w% Voltar ao menu   
echo.                     
echo.
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                               %W%Ativa/desativa o hardware da GPU Programação acelerada, na maioria dos casos é melhor desabilitada
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════"%w%
echo. 
echo. 
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                
echo.                                                                 %p%[%w%1%p%]%w% Aplicar otimizações gerais de USB
echo. 
echo.                                                                                         
echo.                                                                            %p%[%w%M%p%]%w% Voltar ao menu   
echo.
...
echo.
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                  %W%Aplica um monte de otimizações relacionadas a usb, desativa a suspensão seletiva, etc...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════"%w%
echo. 
echo. 
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════"%w%                    
echo.                                                                                          
echo.                                                           %p%[%w%1%p%]%w% Aplicar otimizações de registro KBM       
echo.                                                                                           
...
echo.                                                                                            
echo.                                             %b%"════════════════════════════════════════════════════════════════"
echo.                                             %w% Otimiza várias configurações de registro relacionadas ao mouse e teclado
echo.                                             %b%"════════════════════════════════════════════════════════════════"
echo.
...
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════"   
echo.                                                                                                                       
echo.                                                    %p%[%w%1%p%]%w% 14 (CPU de ponta) %p%[%w%2%p%]%w% 17 (CPU de gama média) %p%[%w%3%p%]%w% 20(CPU de gama baixa)                  
echo.                                                                                                                                                                                       
echo.                                                                                                                      
echo.                                                    %p%%p%%p%%p% %p%[%w%T%p%]%w% Abrir Gerenciador de Tarefas                                     
echo.                                                                                                                       
...
echo.                                                                                          
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════"
echo.                                                              %w% Quanto menor o valor, menos latência periférica você terá
echo.                                                       %w% Mas pode causar gagueira KBM e lag em PCs de extremidade inferior se o valor for muito alto
echo.
echo.                                                %w% Comente sua CPU no vídeo tutorial do youtube, e nós lhe diremos qual valor usar
echo.                                             %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════"
echo.
set /p input=: 
